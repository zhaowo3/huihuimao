<template>
  <el-row class="detailsScroll" >
    <div  class="templateSubject" style="overflow: hidden;">
      ...
      <el-col :span="8" class="templateLeft" style="overflow: hidden;" @infinite-scroll="getMoreList">
        <div  @scroll="eventsBand($event)" class="templateLeft" style="overflow: hidden;">
          <ul class="clearfix" id="leftBox">
            <li v-for="(data,index) in datasd" :key="index" :class="index==cur?'hit':''" @click="infoViews(data.id,index)">
              <el-main>
                <div class="templateLeftImg"><img :src="smalls"></div>
                <div class="templateLeftSpan"><p>{{data.name}}</p><span>库位:{{data.location}}</span><el-button class="templateButton" v-if="data.type==1">包</el-button></div>
              </el-main>
            </li>
            ...
            <el-container>
              <div class="listHeader" v-if="Object.keys(danViews).length>0">
                <div class="listHeaderOne">
                  ...
                  <el-col :span="12"><h4>{{danViews.location}}</h4><p>库位:</p></el-col>
                </div>
                ...
                <div class="picturesList">
                  <div class="picturesListImg"><img :src="big"></div>
                  <div class="picturesListCenter">
                    <el-row>
                      <el-col :span="12"><div class="grid-content bg-purple"><p>包装单位</p><span>{{danViews.bigUnitDesc}}</span></div></el-col>
                      <el-col :span="12"><div class="grid-content bg-purple"><p>最小单位</p><span>{{danViews.smallUnitDesc}}</span></div></el-col>
                      <el-col :span="12"><div class="grid-content bg-purple"><p>数量</p><span>{{danViews.supplyQuantity}}</span></div></el-col>
                      <el-col :span="12"><div class="grid-content bg-purple"><p>预警数量</p><span>{{danViews.warnQuantity}}</span></div></el-col>
                      <el-col :span="12"><div class="grid-content bg-purple"><p>是否启用</p><span>{{danViews.isDel===null?'是':'否'}}</span></div></el-col>
                      <el-col :span="12"><div class="grid-content bg-purple-light"><p>计费</p><span>{{danViews.isFee===null?'是':'否'}}</span></div></el-col>
                      <el-col :span="12"><div class="grid-content bg-purple-light"><p>关联HIS</p><span>{{danViews.hisCode}}</span></div></el-col>
                      <el-col :span="12"><div class="grid-content bg-purple-light"><p>拼音</p><span>{{danViews.pinyin}}</span></div></el-col>
                    </el-row>
