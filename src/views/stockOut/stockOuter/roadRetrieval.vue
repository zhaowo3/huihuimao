...
<!--                  <img alt="" :src="smalls" v-real-img="data.imgUrl">-->
                ...
                <div class="listHeader" v-if="Object.keys(danViews).length>0">
                  <div class="listHeightList">
                    ...
                    <div class="listHeaderTwo">
                      ...
                      <el-button @click="showH(danViews)" v-if="danViews.supplyQuantity!==0&&$route.query.operation==1">打开</el-button>
            ...
            <div class="carouselLS">
              ...
              <div class="carouselRight">
                ...
                <div class="crumbHight" v-if="danViews.codeType==2||danViews.codeType==3">
                  <el-input-number v-model="num1" :min="1" :max="dataStas.supplyQuantity"   label="输入数字"></el-input-number>
                </div>
              </div>
            </div>
          </div>
      ...
      <el-dialog title="请扫码出库" :visible.sync="dialogTableVisible" :before-close="handleClose"
          ...
          <div style="flex: 3">
            <div class="carouselLS">
              ...
              <div class="carouselRight">
                ...
                <p class="textes">库位：{{dataStas.location}}</p>
                <div class="crumbHight" v-if="danViews.codeType==2||danViews.codeType==3">
                  <el-input-number v-model="num1" :min="1" :disabled="false" :max="dataStas.supplyQuantity" label="输入数字"></el-input-number>
                </div>
                <el-input v-model="inputSweep" ref='gain' autofocus="autofocus" clearable @keyup.enter="enterL" class="cumens"
                          placeholder="物资编码">
      ...
      //  无码出库
        NoCodeOk(data){
            ...
            if (res.code == 1) {
                ...
                // if( mv.danViews.supplyQuantit>=0){
                //
                // }
